...
<html>
<head>
    <title>Ubuntu 24.04 LTS CIS Compliance Report - Vijenex</title>
    <meta charset="UTF-8">
    <style>
...
<body>
    <div class="header">
        <h1>🛡️ Ubuntu 24.04 LTS CIS Compliance Report</h1>
    ...
    <div class="container">
        ...
        <div class="footer">
            <p>Generated by Vijenex CIS Scanner for Ubuntu 24.04 LTS (Level 2 controls excluded)</p>
