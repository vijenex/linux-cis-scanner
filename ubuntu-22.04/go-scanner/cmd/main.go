...
import (
	...
	"github.com/vijenex/linux-cis-scanner/ubuntu-22.04/internal/scanner"
)
...
func main() {
	var rootCmd = &cobra.Command{
		Use:   "vijenex-cis",
		Short: "Vijenex CIS Scanner for Ubuntu 22.04 LTS",
		Long: `
...
func runScan(cmd *cobra.Command, args []string) {
	...
	fmt.Println("           Ubuntu 22.04 LTS Benchmark                       ")
