# Updating Ubuntu 22.04 Milestone Files

This guide explains how to update milestone files with description and remediation steps from the official CIS Ubuntu 22.04 Benchmark document.

## Prerequisites

1. **Official CIS Document**: Download the official CIS Ubuntu 22.04 LTS Benchmark (PDF or RTF format)
...
Place your official CIS Ubuntu 22.04 Benchmark document in a known location, for example:
- `~/Downloads/CIS_Ubuntu_22.04_LTS_Benchmark_v1.0.0.pdf`
- `~/Desktop/CIS-Official-docs/CIS_Ubuntu_22.04_Benchmark.rtf`
...
```json
{
  ...
  "cis_reference": "CIS Ubuntu 22.04 - 1.1.1.1 | Level 1",
